...
const SecretSeedPath = "/var/lib/openstack/secret-seed"
...
func GetDashboardEnabledVolumeMount() corev1.VolumeMount {
	return corev1.VolumeMount{
		Name:      "dashboard-enabled",
		MountPath: DashboardEnabledFinalPath,
	}
}
...
func GetSettingsHashVolumeMount() corev1.VolumeMount {
	return corev1.VolumeMount{
		Name:      "settings-hash",
		MountPath: "/var/lib/openstack/settings-hash",
	}
}
